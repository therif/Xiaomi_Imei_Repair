...
for %%A in ("%~dp0\Kenzo_Global_Fix_4G_MIUI.V10.2.1.0.MHOMIXM\images") Do set "_CSC_Dir=%%~fA"

echo FLASHING GLOBAL FIRMWARE 10.2.1.0 Auto 4G
echo:
...
echo:
echo:
echo Step Proses Normal Flashing 4G
echo:
